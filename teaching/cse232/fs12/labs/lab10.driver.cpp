...
/******************************************************************************
  Lab Exercise #10 -- test bed for type "Sequence"
  Modified By Kenneth Hanson (11/5/12)
******************************************************************************/
...
int main()
{
  ...
  // TODO: check an item in the list
  //cout << "Item " << "..." << " at position " << "..." << endl;
  
  // TODO: check an item not in the list
